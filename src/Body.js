...
function Body() {
  return (
    ...
    <div className="card-body">
         <p className="card-text">This property was designed by renowned architect Sir Terry Farrell, considered to be one of London’s best Central London's scheme.</p>
         </div>
        </div>
            </div>
  </div>
